...
[![Build Status](https://img.shields.io/travis/brronsuite/lnd.svg)](https://travis-ci.org/brronsuite/lnd)
...
[![Godoc](https://godoc.org/github.com/brronsuite/lnd?status.svg)](https://godoc.org/github.com/brronsuite/lnd)

<img src="logo.png">

The Lightning Network Daemon (`lnd`) - is a complete implementation of a
[Lightning Network](https://lightning.network) node.  `lnd` has several pluggable back-end
chain services including [`btcd`](https://github.com/brronsuite/brond) (a
...
* Automatic channel management ([`autopilot`](https://github.com/brronsuite/lnd/tree/master/autopilot)).
...
## Further reading
* [Step-by-step send payment guide with docker](https://github.com/brronsuite/lnd/tree/master/docker)
* [Contribution guide](https://github.com/brronsuite/lnd/blob/master/docs/code_contribution_guidelines.md)
# lnd
