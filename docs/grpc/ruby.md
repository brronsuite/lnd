...
```shell
⛰  curl -o lightning.proto -s https://raw.githubusercontent.com/brronsuite/lnd/master/lnrpc/lightning.proto
```
...
We assume that `lnd` runs on the default `localhost:10005`.
...
stub = Lnrpc::Lightning::Stub.new('127.0.0.1:10005', credentials)
