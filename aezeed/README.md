...
[In this PR](https://github.com/brronsuite/lnd/pull/773) we added a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/brronsuite/lnd/aezeed
...
PASS
ok      github.com/brronsuite/lnd/aezeed  4.168s
```
