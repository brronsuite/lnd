...
- Changes to publicly exported packages such as
  [brontide](https://github.com/brronsuite/lnd/tree/master/brontide) should
...
- Changes to behavior within the daemon's interaction with the P2P protocol,
  ...
  [`networkHarness`framework](https://github.com/brronsuite/lnd/blob/master/lntest/harness.go)
  contained within `lnd`. For example integration tests, see
  [`lnd_test.go`](https://github.com/brronsuite/lnd/blob/master/lnd_test.go#L181). 
...
[perusing the make file documentation](https://github.com/brronsuite/lnd/blob/master/docs/MAKEFILE.md).
...
definitions, check out the [lnrpc README](https://github.com/brronsuite/lnd/blob/master/lnrpc/README.md).
...
PR](https://github.com/brronsuite/lnd/tree/master/docs/release-notes).
...
Rejoice as you will now be listed as a [contributor](https://github.com/brronsuite/lnd/graphs/contributors)!
...
[MIT license](https://github.com/brronsuite/lnd/blob/master/LICENSE).  This is
