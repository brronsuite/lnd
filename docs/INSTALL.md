...
mainnet.
[Visit the release page on GitHub](https://github.com/brronsuite/lnd/releases)
...
```shell
⛰  git clone https://github.com/brronsuite/lnd
⛰  cd lnd
...
### Preliminaries for installing from source
  In order to work with [`lnd`](https://github.com/brronsuite/lnd), the
...
release](https://github.com/brronsuite/lnd/releases). Assuming the name
...
commands:
```shell
⛰  cd $GOPATH/src/github.com/brronsuite/lnd
⛰  git pull
...
Github](https://github.com/brronsuite/lnd/issues/20).
...
[here](https://github.com/brronsuite/lnd/blob/master/sample-lnd.conf)
