...
`btcd`
------
Ensures that the [`github.com/brronsuite/brond`][btcd] repository is checked out
locally. Lastly, installs the version of 
[`github.com/brronsuite/brond`][btcd] specified in `Gopkg.toml`
...
`check`
-------
Installs the version of [`github.com/brronsuite/brond`][btcd] specified
...
`itest`
-------
Installs the version of [`github.com/brronsuite/brond`][btcd] specified in
...
[btcd]: https://github.com/brronsuite/brond (github.com/brronsuite/brond")
